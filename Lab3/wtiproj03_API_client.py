...
def main():
    ...
    # post = requests.post('http://127.0.0.1:8080/rating', data=json.dumps(add_data))
    # printdata(post)
    # time.sleep(0.01)
    # delete = requests.delete('http://127.0.0.1:8080/ratings', data=json.dumps(delete_data))
    # time.sleep(0.01)
    # printdata(delete)
    # getratings = requests.get('http://127.0.0.1:8080/ratings')
    # time.sleep(0.01)
    # printdata(getratings)
    # getavggenre = requests.get('http://127.0.0.1:8080/avg-genre-ratings/all-users')
    # time.sleep(0.01)
    # printdata(getavggenre)
    getuseravg = requests.get('http://127.0.0.1:8080/avg-genre-ratings/user/71510')
    time.sleep(0.01)
